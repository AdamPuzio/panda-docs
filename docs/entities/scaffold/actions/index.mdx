...
Custom actions can be defined by the scaffold author. They are defined in the `actionTypes` property of the scaffold.

For more information on custom actions, see the [Action Types](/docs/entities/scaffold/properties/actiontypes) documentation.
